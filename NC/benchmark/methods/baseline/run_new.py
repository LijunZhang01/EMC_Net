...
from model.GNN_self import myGAT
import dgl
...
def run_model_DBLP(args):
    ...
    for _ in range(args.repeat):
        ...
        net.load_state_dict(torch.load('./NC/benchmark/methods/baseline/checkpoint/checkpoint_{}_{}.pt'.format(args.dataset, args.num_layers)))
        net.eval()
        test_logits = []
        with torch.no_grad():
