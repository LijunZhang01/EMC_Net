...
def run_model_DBLP(args,feats_type, hidden_dim, num_heads, attn_vec_dim, rnn_type,
    ...
    adjlists, edge_metapath_indices_list, features_list, adjM, type_mask, labels, train_val_test_idx, dl,emb = load_ACM_data()
    ...
    for _ in range(repeat):
        print(emb.shape)
        net = MAGNN_nc_mb(6, 8, etypes_list, in_dims, hidden_dim, out_dim, num_heads, attn_vec_dim, emb.size()[1],rnn_type, dropout_rate)
        net.to(device)
